/*
 ...
 Source Server         : Externo
 Source Server Type    : MySQL
 Source Server Version : 100515
 Source Host           : sql749.main-hosting.eu:3306
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Catálogo de cajas registradoras de cobro' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `carga_masiva`  (
  `cve_carga` int(11) NOT NULL AUTO_INCREMENT,
  `cve_entrada` int(11) NULL DEFAULT NULL,
  ...
  `cve_producto` int(11) NULL DEFAULT NULL,
  `cve_categoria` int(11) NULL DEFAULT NULL,
  `cve_producto_sucursal` int(11) NULL DEFAULT NULL,
...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'Catálogo de categorías de productos' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `cortes_cajas`  (
  ...
  `fecha_inicio` timestamp(0) NULL DEFAULT NULL COMMENT 'Fecha y hora de inicio del corte de caja',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Almacena los cortes de caja' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of cortes_cajas
-- ----------------------------
INSERT INTO `cortes_cajas` VALUES (1, 'BE7ECDC4-3692-471E-B55D-668720048C65', 1, '2022-06-01 14:06:45', NULL, NULL, 'ABIERTO', '12', '2022-06-01 19:06:45', 'VIG', NULL, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Almacena las entradas de material' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `menus` VALUES (15, 1, 'Corte Caja', '/consultas/cortes-caja', 3, '2022-04-07 21:59:20', 'VIG', 2, NULL);
...
INSERT INTO `menus` VALUES (24, 1, 'Corte de Caja', '/reportes/cortes-caja', 6, '2022-04-07 21:59:20', 'VIG', 3, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra los movimientos de valores durante un corte de caja' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 421 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Catálogo de productos o materiales' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 575 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra las descripciones asociadas a los productos' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 421 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Contiene la existencia de productos en una sucursal' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of productos_sucursales
-- ----------------------------
INSERT INTO `productos_sucursales` VALUES (1, 1, 1, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 434.280, 434.280, 629.160, 749.00, 517.00, 1, 232.00, NULL);
INSERT INTO `productos_sucursales` VALUES (2, 1, 2, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.000, 63.000, 91.560, 109.00, 75.00, 1, 34.00, NULL);
INSERT INTO `productos_sucursales` VALUES (3, 1, 3, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 231.000, 231.000, 335.160, 399.00, 275.00, 1, 124.00, NULL);
INSERT INTO `productos_sucursales` VALUES (4, 1, 4, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 86.520, 86.520, 125.160, 149.00, 103.00, 1, 46.00, NULL);
INSERT INTO `productos_sucursales` VALUES (5, 1, 5, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 132.720, 132.720, 192.360, 229.00, 158.00, 1, 71.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (7, 1, 7, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 694.680, 694.680, 1007.160, 1199.00, 827.00, 1, 372.00, NULL);
INSERT INTO `productos_sucursales` VALUES (8, 1, 8, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 168.000, 168.000, 243.600, 290.00, 200.00, 1, 90.00, NULL);
INSERT INTO `productos_sucursales` VALUES (9, 1, 9, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 87.360, 87.360, 126.000, 150.00, 104.00, 1, 46.00, NULL);
INSERT INTO `productos_sucursales` VALUES (10, 1, 10, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 40.320, 40.320, 57.960, 69.00, 48.00, 1, 21.00, NULL);
INSERT INTO `productos_sucursales` VALUES (11, 1, 11, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 159.600, 159.600, 354.480, 422.00, 190.00, 1, 232.00, NULL);
INSERT INTO `productos_sucursales` VALUES (12, 1, 12, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 339.360, 339.360, 828.240, 986.00, 404.00, 1, 582.00, NULL);
INSERT INTO `productos_sucursales` VALUES (13, 1, 13, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 483.000, 483.000, 1128.960, 1344.00, 575.00, 1, 769.00, NULL);
INSERT INTO `productos_sucursales` VALUES (14, 1, 14, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 102.480, 102.480, 200.760, 239.00, 122.00, 1, 117.00, NULL);
INSERT INTO `productos_sucursales` VALUES (15, 1, 15, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 30.240, 30.240, 56.280, 67.00, 36.00, 1, 31.00, NULL);
INSERT INTO `productos_sucursales` VALUES (16, 1, 16, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 33.600, 33.600, 78.120, 93.00, 40.00, 1, 53.00, NULL);
INSERT INTO `productos_sucursales` VALUES (17, 1, 17, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 379.680, 379.680, 940.800, 1120.00, 452.00, 1, 668.00, NULL);
INSERT INTO `productos_sucursales` VALUES (18, 1, 18, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.960, 15.960, 33.600, 40.00, 19.00, 1, 21.00, NULL);
INSERT INTO `productos_sucursales` VALUES (19, 1, 19, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.960, 15.960, 33.600, 40.00, 19.00, 1, 21.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (21, 1, 21, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 151.200, 151.200, 368.760, 439.00, 180.00, 1, 259.00, NULL);
INSERT INTO `productos_sucursales` VALUES (22, 1, 22, 40.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 4.200, 4.200, 7.560, 9.00, 5.00, 1, 4.00, NULL);
INSERT INTO `productos_sucursales` VALUES (23, 1, 23, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 70.560, 70.560, 157.080, 187.00, 84.00, 1, 103.00, NULL);
INSERT INTO `productos_sucursales` VALUES (24, 1, 24, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 45.360, 45.360, 106.680, 127.00, 54.00, 1, 73.00, NULL);
INSERT INTO `productos_sucursales` VALUES (25, 1, 25, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 193.200, 193.200, 428.400, 510.00, 230.00, 1, 280.00, NULL);
INSERT INTO `productos_sucursales` VALUES (26, 1, 26, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 869.400, 869.400, 2135.280, 2542.00, 1035.00, 1, 1507.00, NULL);
INSERT INTO `productos_sucursales` VALUES (27, 1, 27, 16.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 2.520, 2.520, 4.200, 5.00, 3.00, 1, 2.00, NULL);
INSERT INTO `productos_sucursales` VALUES (28, 1, 28, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 7.560, 7.560, 16.800, 20.00, 9.00, 1, 11.00, NULL);
INSERT INTO `productos_sucursales` VALUES (29, 1, 29, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1.680, 1.680, 4.200, 5.00, 2.00, 1, 3.00, NULL);
INSERT INTO `productos_sucursales` VALUES (30, 1, 30, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 19.320, 19.320, 49.560, 59.00, 23.00, 1, 36.00, NULL);
INSERT INTO `productos_sucursales` VALUES (31, 1, 31, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 621.600, 621.600, 1218.840, 1451.00, 740.00, 1, 711.00, NULL);
INSERT INTO `productos_sucursales` VALUES (32, 1, 32, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 467.880, 467.880, 1118.880, 1332.00, 557.00, 1, 775.00, NULL);
INSERT INTO `productos_sucursales` VALUES (33, 1, 33, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 171.360, 171.360, 401.520, 478.00, 204.00, 1, 274.00, NULL);
INSERT INTO `productos_sucursales` VALUES (34, 1, 34, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 10.080, 10.080, 24.360, 29.00, 12.00, 1, 17.00, NULL);
INSERT INTO `productos_sucursales` VALUES (35, 1, 35, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 131.880, 131.880, 293.160, 349.00, 157.00, 1, 192.00, NULL);
INSERT INTO `productos_sucursales` VALUES (36, 1, 36, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 58.800, 58.800, 131.040, 156.00, 70.00, 1, 86.00, NULL);
INSERT INTO `productos_sucursales` VALUES (37, 1, 37, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.000, 63.000, 87.360, 104.00, 75.00, 1, 29.00, NULL);
INSERT INTO `productos_sucursales` VALUES (38, 1, 38, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 34.440, 34.440, 81.480, 97.00, 41.00, 1, 56.00, NULL);
INSERT INTO `productos_sucursales` VALUES (39, 1, 39, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 756.000, 756.000, 1814.400, 2160.00, 900.00, 1, 1260.00, NULL);
INSERT INTO `productos_sucursales` VALUES (40, 1, 40, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 20.160, 20.160, 48.720, 58.00, 24.00, 1, 34.00, NULL);
INSERT INTO `productos_sucursales` VALUES (41, 1, 41, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 32.760, 32.760, 75.600, 90.00, 39.00, 1, 51.00, NULL);
INSERT INTO `productos_sucursales` VALUES (42, 1, 42, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 10.920, 10.920, 27.720, 33.00, 13.00, 1, 20.00, NULL);
INSERT INTO `productos_sucursales` VALUES (43, 1, 43, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 8.400, 8.400, 21.000, 25.00, 10.00, 1, 15.00, NULL);
INSERT INTO `productos_sucursales` VALUES (44, 1, 44, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.040, 26.040, 63.840, 76.00, 31.00, 1, 45.00, NULL);
INSERT INTO `productos_sucursales` VALUES (45, 1, 45, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 13.440, 13.440, 34.440, 41.00, 16.00, 1, 25.00, NULL);
INSERT INTO `productos_sucursales` VALUES (46, 1, 46, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 54.600, 54.600, 105.000, 125.00, 65.00, 1, 60.00, NULL);
INSERT INTO `productos_sucursales` VALUES (47, 1, 47, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.000, 63.000, 142.800, 170.00, 75.00, 1, 95.00, NULL);
INSERT INTO `productos_sucursales` VALUES (48, 1, 48, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 49.560, 49.560, 115.920, 138.00, 59.00, 1, 79.00, NULL);
INSERT INTO `productos_sucursales` VALUES (49, 1, 49, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 108.360, 108.360, 241.080, 287.00, 129.00, 1, 158.00, NULL);
INSERT INTO `productos_sucursales` VALUES (50, 1, 50, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 33.600, 33.600, 78.120, 93.00, 40.00, 1, 53.00, NULL);
INSERT INTO `productos_sucursales` VALUES (51, 1, 51, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 211.680, 211.680, 471.240, 561.00, 252.00, 1, 309.00, NULL);
INSERT INTO `productos_sucursales` VALUES (52, 1, 52, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 242.760, 242.760, 607.320, 723.00, 289.00, 1, 434.00, NULL);
INSERT INTO `productos_sucursales` VALUES (53, 1, 53, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 205.800, 205.800, 457.800, 545.00, 245.00, 1, 300.00, NULL);
INSERT INTO `productos_sucursales` VALUES (54, 1, 54, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 300.720, 300.720, 703.920, 838.00, 358.00, 1, 480.00, NULL);
INSERT INTO `productos_sucursales` VALUES (55, 1, 55, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 241.080, 241.080, 477.120, 568.00, 287.00, 1, 281.00, NULL);
INSERT INTO `productos_sucursales` VALUES (56, 1, 56, 30.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 23.520, 23.520, 61.320, 73.00, 28.00, 1, 45.00, NULL);
INSERT INTO `productos_sucursales` VALUES (57, 1, 57, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 37.800, 37.800, 84.000, 100.00, 45.00, 1, 55.00, NULL);
INSERT INTO `productos_sucursales` VALUES (58, 1, 58, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 52.920, 52.920, 122.640, 146.00, 63.00, 1, 83.00, NULL);
INSERT INTO `productos_sucursales` VALUES (59, 1, 59, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 20.160, 20.160, 44.520, 53.00, 24.00, 1, 29.00, NULL);
INSERT INTO `productos_sucursales` VALUES (60, 1, 60, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 30.240, 30.240, 74.760, 89.00, 36.00, 1, 53.00, NULL);
INSERT INTO `productos_sucursales` VALUES (61, 1, 61, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 17.640, 17.640, 24.360, 29.00, 21.00, 1, 8.00, NULL);
INSERT INTO `productos_sucursales` VALUES (62, 1, 62, 16.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 33.600, 40.00, 18.00, 1, 22.00, NULL);
INSERT INTO `productos_sucursales` VALUES (63, 1, 63, 16.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 11.760, 11.760, 22.680, 27.00, 14.00, 1, 13.00, NULL);
INSERT INTO `productos_sucursales` VALUES (64, 1, 64, 15.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 16.800, 16.800, 36.120, 43.00, 20.00, 1, 23.00, NULL);
INSERT INTO `productos_sucursales` VALUES (65, 1, 65, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 45.360, 45.360, 105.840, 126.00, 54.00, 1, 72.00, NULL);
INSERT INTO `productos_sucursales` VALUES (66, 1, 66, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 157.920, 157.920, 383.880, 457.00, 188.00, 1, 269.00, NULL);
INSERT INTO `productos_sucursales` VALUES (67, 1, 67, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 33.600, 33.600, 73.920, 88.00, 40.00, 1, 48.00, NULL);
INSERT INTO `productos_sucursales` VALUES (68, 1, 68, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1.680, 1.680, 2.520, 3.00, 2.00, 1, 1.00, NULL);
INSERT INTO `productos_sucursales` VALUES (69, 1, 69, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 78.120, 78.120, 173.880, 207.00, 93.00, 1, 114.00, NULL);
INSERT INTO `productos_sucursales` VALUES (70, 1, 70, 60.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 0.840, 0.840, 2.520, 3.00, 1.00, 1, 2.00, NULL);
INSERT INTO `productos_sucursales` VALUES (71, 1, 71, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 68.880, 68.880, 153.720, 183.00, 82.00, 1, 101.00, NULL);
INSERT INTO `productos_sucursales` VALUES (72, 1, 72, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 10.920, 10.920, 24.360, 29.00, 13.00, 1, 16.00, NULL);
INSERT INTO `productos_sucursales` VALUES (73, 1, 73, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 247.800, 247.800, 551.040, 656.00, 295.00, 1, 361.00, NULL);
INSERT INTO `productos_sucursales` VALUES (74, 1, 74, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 317.520, 317.520, 706.440, 841.00, 378.00, 1, 463.00, NULL);
INSERT INTO `productos_sucursales` VALUES (75, 1, 75, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 30.240, 30.240, 66.360, 79.00, 36.00, 1, 43.00, NULL);
INSERT INTO `productos_sucursales` VALUES (76, 1, 76, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 99.120, 99.120, 220.920, 263.00, 118.00, 1, 145.00, NULL);
INSERT INTO `productos_sucursales` VALUES (77, 1, 77, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 89.880, 89.880, 201.600, 240.00, 107.00, 1, 133.00, NULL);
INSERT INTO `productos_sucursales` VALUES (78, 1, 78, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 106.680, 106.680, 272.160, 324.00, 127.00, 1, 197.00, NULL);
INSERT INTO `productos_sucursales` VALUES (79, 1, 79, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 595.560, 595.560, 1516.200, 1805.00, 709.00, 1, 1096.00, NULL);
INSERT INTO `productos_sucursales` VALUES (80, 1, 80, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 778.680, 778.680, 1821.120, 2168.00, 927.00, 1, 1241.00, NULL);
INSERT INTO `productos_sucursales` VALUES (81, 1, 81, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 78.120, 78.120, 173.040, 206.00, 93.00, 1, 113.00, NULL);
INSERT INTO `productos_sucursales` VALUES (82, 1, 82, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 38.640, 38.640, 92.400, 110.00, 46.00, 1, 64.00, NULL);
INSERT INTO `productos_sucursales` VALUES (83, 1, 83, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 102.480, 102.480, 228.480, 272.00, 122.00, 1, 150.00, NULL);
INSERT INTO `productos_sucursales` VALUES (84, 1, 84, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 19.320, 19.320, 47.880, 57.00, 23.00, 1, 34.00, NULL);
INSERT INTO `productos_sucursales` VALUES (85, 1, 85, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 22.680, 22.680, 51.240, 61.00, 27.00, 1, 34.00, NULL);
INSERT INTO `productos_sucursales` VALUES (86, 1, 86, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 45.360, 45.360, 99.960, 119.00, 54.00, 1, 65.00, NULL);
INSERT INTO `productos_sucursales` VALUES (87, 1, 87, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.080, 31.080, 65.520, 78.00, 37.00, 1, 41.00, NULL);
INSERT INTO `productos_sucursales` VALUES (88, 1, 88, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 22.680, 22.680, 50.400, 60.00, 27.00, 1, 33.00, NULL);
INSERT INTO `productos_sucursales` VALUES (89, 1, 89, 11.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 11.760, 11.760, 18.480, 22.00, 14.00, 1, 8.00, NULL);
INSERT INTO `productos_sucursales` VALUES (90, 1, 90, 25.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 16.800, 16.800, 36.960, 44.00, 20.00, 1, 24.00, NULL);
INSERT INTO `productos_sucursales` VALUES (91, 1, 91, 21.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 37.800, 45.00, 18.00, 1, 27.00, NULL);
INSERT INTO `productos_sucursales` VALUES (92, 1, 92, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 24.360, 24.360, 54.600, 65.00, 29.00, 1, 36.00, NULL);
INSERT INTO `productos_sucursales` VALUES (93, 1, 93, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 7.560, 7.560, 18.480, 22.00, 9.00, 1, 13.00, NULL);
INSERT INTO `productos_sucursales` VALUES (94, 1, 94, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 6.720, 6.720, 14.280, 17.00, 8.00, 1, 9.00, NULL);
INSERT INTO `productos_sucursales` VALUES (95, 1, 95, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 14.280, 14.280, 31.920, 38.00, 17.00, 1, 21.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (97, 1, 97, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 10.920, 10.920, 26.880, 32.00, 13.00, 1, 19.00, NULL);
INSERT INTO `productos_sucursales` VALUES (98, 1, 98, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 82.320, 82.320, 192.360, 229.00, 98.00, 1, 131.00, NULL);
INSERT INTO `productos_sucursales` VALUES (99, 1, 99, 16.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 2.520, 2.520, 5.040, 6.00, 3.00, 1, 3.00, NULL);
INSERT INTO `productos_sucursales` VALUES (100, 1, 100, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 306.600, 306.600, 680.400, 810.00, 365.00, 1, 445.00, NULL);
INSERT INTO `productos_sucursales` VALUES (101, 1, 101, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 42.000, 42.000, 102.480, 122.00, 50.00, 1, 72.00, NULL);
INSERT INTO `productos_sucursales` VALUES (102, 1, 102, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.920, 31.920, 71.400, 85.00, 38.00, 1, 47.00, NULL);
INSERT INTO `productos_sucursales` VALUES (103, 1, 103, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 22.680, 22.680, 56.280, 67.00, 27.00, 1, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (104, 1, 104, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 22.680, 22.680, 58.800, 70.00, 27.00, 1, 43.00, NULL);
INSERT INTO `productos_sucursales` VALUES (105, 1, 105, 13.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 27.720, 27.720, 70.560, 84.00, 33.00, 1, 51.00, NULL);
INSERT INTO `productos_sucursales` VALUES (106, 1, 106, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 38.640, 38.640, 101.640, 121.00, 46.00, 1, 75.00, NULL);
INSERT INTO `productos_sucursales` VALUES (107, 1, 107, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.000, 63.000, 140.280, 167.00, 75.00, 1, 92.00, NULL);
INSERT INTO `productos_sucursales` VALUES (108, 1, 108, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 46.200, 46.200, 113.400, 135.00, 55.00, 1, 80.00, NULL);
INSERT INTO `productos_sucursales` VALUES (109, 1, 109, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 23.520, 23.520, 59.640, 71.00, 28.00, 1, 43.00, NULL);
INSERT INTO `productos_sucursales` VALUES (110, 1, 110, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.880, 26.880, 67.200, 80.00, 32.00, 1, 48.00, NULL);
INSERT INTO `productos_sucursales` VALUES (111, 1, 111, 24.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.880, 26.880, 58.800, 70.00, 32.00, 1, 38.00, NULL);
INSERT INTO `productos_sucursales` VALUES (112, 1, 112, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 24.360, 24.360, 62.160, 74.00, 29.00, 1, 45.00, NULL);
INSERT INTO `productos_sucursales` VALUES (113, 1, 113, 22.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 47.880, 47.880, 105.840, 126.00, 57.00, 1, 69.00, NULL);
INSERT INTO `productos_sucursales` VALUES (114, 1, 114, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 68.880, 68.880, 153.720, 183.00, 82.00, 1, 101.00, NULL);
INSERT INTO `productos_sucursales` VALUES (115, 1, 115, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.880, 26.880, 60.480, 72.00, 32.00, 1, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (116, 1, 116, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 38.640, 38.640, 100.800, 120.00, 46.00, 1, 74.00, NULL);
INSERT INTO `productos_sucursales` VALUES (117, 1, 117, 14.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 40.320, 40.320, 98.280, 117.00, 48.00, 1, 69.00, NULL);
INSERT INTO `productos_sucursales` VALUES (118, 1, 118, 12.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 61.320, 61.320, 136.920, 163.00, 73.00, 1, 90.00, NULL);
INSERT INTO `productos_sucursales` VALUES (119, 1, 119, 17.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 33.600, 33.600, 86.520, 103.00, 40.00, 1, 63.00, NULL);
INSERT INTO `productos_sucursales` VALUES (120, 1, 120, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 21.840, 21.840, 54.600, 65.00, 26.00, 1, 39.00, NULL);
INSERT INTO `productos_sucursales` VALUES (121, 1, 121, 23.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 43.680, 43.680, 96.600, 115.00, 52.00, 1, 63.00, NULL);
INSERT INTO `productos_sucursales` VALUES (122, 1, 122, 15.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 22.680, 22.680, 58.800, 70.00, 27.00, 1, 43.00, NULL);
INSERT INTO `productos_sucursales` VALUES (123, 1, 123, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 67.200, 67.200, 171.360, 204.00, 80.00, 1, 124.00, NULL);
INSERT INTO `productos_sucursales` VALUES (124, 1, 124, 19.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.880, 26.880, 68.040, 81.00, 32.00, 1, 49.00, NULL);
INSERT INTO `productos_sucursales` VALUES (125, 1, 125, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 83.160, 83.160, 183.960, 219.00, 99.00, 1, 120.00, NULL);
INSERT INTO `productos_sucursales` VALUES (126, 1, 126, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 57.120, 57.120, 127.680, 152.00, 68.00, 1, 84.00, NULL);
INSERT INTO `productos_sucursales` VALUES (127, 1, 127, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 69.720, 69.720, 149.520, 178.00, 83.00, 1, 95.00, NULL);
INSERT INTO `productos_sucursales` VALUES (128, 1, 128, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 65.520, 65.520, 159.600, 190.00, 78.00, 1, 112.00, NULL);
INSERT INTO `productos_sucursales` VALUES (129, 1, 129, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 65.520, 65.520, 160.440, 191.00, 78.00, 1, 113.00, NULL);
INSERT INTO `productos_sucursales` VALUES (130, 1, 130, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 4.200, 4.200, 11.760, 14.00, 5.00, 1, 9.00, NULL);
INSERT INTO `productos_sucursales` VALUES (131, 1, 131, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 42.000, 42.000, 94.080, 112.00, 50.00, 1, 62.00, NULL);
INSERT INTO `productos_sucursales` VALUES (132, 1, 132, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 78.960, 78.960, 174.720, 208.00, 94.00, 1, 114.00, NULL);
INSERT INTO `productos_sucursales` VALUES (133, 1, 133, 13.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 78.960, 78.960, 174.720, 208.00, 94.00, 1, 114.00, NULL);
INSERT INTO `productos_sucursales` VALUES (134, 1, 134, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 131.040, 131.040, 290.640, 346.00, 156.00, 1, 190.00, NULL);
INSERT INTO `productos_sucursales` VALUES (135, 1, 135, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 230.160, 230.160, 511.560, 609.00, 274.00, 1, 335.00, NULL);
INSERT INTO `productos_sucursales` VALUES (136, 1, 136, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 85.680, 85.680, 190.680, 227.00, 102.00, 1, 125.00, NULL);
INSERT INTO `productos_sucursales` VALUES (137, 1, 137, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 374.640, 374.640, 831.600, 990.00, 446.00, 1, 544.00, NULL);
INSERT INTO `productos_sucursales` VALUES (138, 1, 138, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 169.680, 169.680, 391.440, 466.00, 202.00, 1, 264.00, NULL);
INSERT INTO `productos_sucursales` VALUES (139, 1, 139, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 400.680, 400.680, 724.080, 862.00, 477.00, 1, 385.00, NULL);
INSERT INTO `productos_sucursales` VALUES (140, 1, 140, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 319.200, 319.200, 551.040, 656.00, 380.00, 1, 276.00, NULL);
INSERT INTO `productos_sucursales` VALUES (141, 1, 141, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 281.400, 281.400, 508.200, 605.00, 335.00, 1, 270.00, NULL);
INSERT INTO `productos_sucursales` VALUES (142, 1, 142, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 253.680, 253.680, 437.640, 521.00, 302.00, 1, 219.00, NULL);
INSERT INTO `productos_sucursales` VALUES (143, 1, 143, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 68.040, 68.040, 151.200, 180.00, 81.00, 1, 99.00, NULL);
INSERT INTO `productos_sucursales` VALUES (144, 1, 144, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 58.800, 58.800, 130.200, 155.00, 70.00, 1, 85.00, NULL);
INSERT INTO `productos_sucursales` VALUES (145, 1, 145, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 74.760, 74.760, 165.480, 197.00, 89.00, 1, 108.00, NULL);
INSERT INTO `productos_sucursales` VALUES (146, 1, 146, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 48.720, 48.720, 107.520, 128.00, 58.00, 1, 70.00, NULL);
INSERT INTO `productos_sucursales` VALUES (147, 1, 147, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 99.120, 99.120, 220.080, 262.00, 118.00, 1, 144.00, NULL);
INSERT INTO `productos_sucursales` VALUES (148, 1, 148, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 171.360, 171.360, 380.520, 453.00, 204.00, 1, 249.00, NULL);
INSERT INTO `productos_sucursales` VALUES (149, 1, 149, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 108.360, 108.360, 241.080, 287.00, 129.00, 1, 158.00, NULL);
INSERT INTO `productos_sucursales` VALUES (150, 1, 150, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 167.160, 167.160, 372.120, 443.00, 199.00, 1, 244.00, NULL);
INSERT INTO `productos_sucursales` VALUES (151, 1, 151, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 114.240, 114.240, 253.680, 302.00, 136.00, 1, 166.00, NULL);
INSERT INTO `productos_sucursales` VALUES (152, 1, 152, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 96.600, 96.600, 214.200, 255.00, 115.00, 1, 140.00, NULL);
INSERT INTO `productos_sucursales` VALUES (153, 1, 153, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 69.720, 69.720, 155.400, 185.00, 83.00, 1, 102.00, NULL);
INSERT INTO `productos_sucursales` VALUES (154, 1, 154, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 85.680, 85.680, 190.680, 227.00, 102.00, 1, 125.00, NULL);
INSERT INTO `productos_sucursales` VALUES (155, 1, 155, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 109.200, 109.200, 242.760, 289.00, 130.00, 1, 159.00, NULL);
INSERT INTO `productos_sucursales` VALUES (156, 1, 156, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 121.800, 121.800, 271.320, 323.00, 145.00, 1, 178.00, NULL);
INSERT INTO `productos_sucursales` VALUES (157, 1, 157, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 173.880, 173.880, 248.640, 296.00, 207.00, 1, 89.00, NULL);
INSERT INTO `productos_sucursales` VALUES (158, 1, 158, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 57.960, 57.960, 129.360, 154.00, 69.00, 1, 85.00, NULL);
INSERT INTO `productos_sucursales` VALUES (159, 1, 159, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 105.840, 105.840, 266.280, 317.00, 126.00, 1, 191.00, NULL);
INSERT INTO `productos_sucursales` VALUES (160, 1, 160, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 325.080, 325.080, 721.560, 859.00, 387.00, 1, 472.00, NULL);
INSERT INTO `productos_sucursales` VALUES (161, 1, 161, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 166.320, 166.320, 420.840, 501.00, 198.00, 1, 303.00, NULL);
INSERT INTO `productos_sucursales` VALUES (162, 1, 162, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 291.480, 291.480, 744.240, 886.00, 347.00, 1, 539.00, NULL);
INSERT INTO `productos_sucursales` VALUES (163, 1, 163, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 55.440, 55.440, 123.480, 147.00, 66.00, 1, 81.00, NULL);
INSERT INTO `productos_sucursales` VALUES (164, 1, 164, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 61.320, 61.320, 136.080, 162.00, 73.00, 1, 89.00, NULL);
INSERT INTO `productos_sucursales` VALUES (165, 1, 165, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 72.240, 72.240, 161.280, 192.00, 86.00, 1, 106.00, NULL);
INSERT INTO `productos_sucursales` VALUES (166, 1, 166, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 75.600, 75.600, 168.000, 200.00, 90.00, 1, 110.00, NULL);
INSERT INTO `productos_sucursales` VALUES (167, 1, 167, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 132.720, 132.720, 327.600, 390.00, 158.00, 1, 232.00, NULL);
INSERT INTO `productos_sucursales` VALUES (168, 1, 168, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 72.240, 72.240, 160.440, 191.00, 86.00, 1, 105.00, NULL);
INSERT INTO `productos_sucursales` VALUES (169, 1, 169, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 881.160, 881.160, 1958.040, 2331.00, 1049.00, 1, 1282.00, NULL);
INSERT INTO `productos_sucursales` VALUES (170, 1, 170, 14.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 23.520, 23.520, 26.880, 32.00, 28.00, 1, 4.00, NULL);
INSERT INTO `productos_sucursales` VALUES (171, 1, 171, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 11.760, 11.760, 21.840, 26.00, 14.00, 1, 12.00, NULL);
INSERT INTO `productos_sucursales` VALUES (172, 1, 172, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 10.080, 10.080, 19.320, 23.00, 12.00, 1, 11.00, NULL);
INSERT INTO `productos_sucursales` VALUES (173, 1, 173, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 4.200, 4.200, 10.920, 13.00, 5.00, 1, 8.00, NULL);
INSERT INTO `productos_sucursales` VALUES (174, 1, 174, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 20.160, 20.160, 52.080, 62.00, 24.00, 1, 38.00, NULL);
INSERT INTO `productos_sucursales` VALUES (175, 1, 175, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.080, 31.080, 69.720, 83.00, 37.00, 1, 46.00, NULL);
INSERT INTO `productos_sucursales` VALUES (176, 1, 176, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 37.800, 37.800, 84.840, 101.00, 45.00, 1, 56.00, NULL);
INSERT INTO `productos_sucursales` VALUES (177, 1, 177, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 78.120, 78.120, 173.040, 206.00, 93.00, 1, 113.00, NULL);
INSERT INTO `productos_sucursales` VALUES (178, 1, 178, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 241.920, 241.920, 538.440, 641.00, 288.00, 1, 353.00, NULL);
INSERT INTO `productos_sucursales` VALUES (179, 1, 179, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 448.560, 448.560, 1059.240, 1261.00, 534.00, 1, 727.00, NULL);
INSERT INTO `productos_sucursales` VALUES (180, 1, 180, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 414.120, 414.120, 919.800, 1095.00, 493.00, 1, 602.00, NULL);
INSERT INTO `productos_sucursales` VALUES (181, 1, 181, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 484.680, 484.680, 1076.880, 1282.00, 577.00, 1, 705.00, NULL);
INSERT INTO `productos_sucursales` VALUES (182, 1, 182, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 45.360, 45.360, 115.080, 137.00, 54.00, 1, 83.00, NULL);
INSERT INTO `productos_sucursales` VALUES (183, 1, 183, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 47.880, 47.880, 120.960, 144.00, 57.00, 1, 87.00, NULL);
INSERT INTO `productos_sucursales` VALUES (184, 1, 184, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 14.280, 14.280, 20.160, 24.00, 17.00, 1, 7.00, NULL);
INSERT INTO `productos_sucursales` VALUES (185, 1, 185, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 68.040, 68.040, 171.360, 204.00, 81.00, 1, 123.00, NULL);
INSERT INTO `productos_sucursales` VALUES (186, 1, 186, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 64.680, 64.680, 162.960, 194.00, 77.00, 1, 117.00, NULL);
INSERT INTO `productos_sucursales` VALUES (187, 1, 187, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 159.600, 159.600, 355.320, 423.00, 190.00, 1, 233.00, NULL);
INSERT INTO `productos_sucursales` VALUES (188, 1, 188, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 159.600, 159.600, 355.320, 423.00, 190.00, 1, 233.00, NULL);
INSERT INTO `productos_sucursales` VALUES (189, 1, 189, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 236.880, 236.880, 525.840, 626.00, 282.00, 1, 344.00, NULL);
INSERT INTO `productos_sucursales` VALUES (190, 1, 190, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 236.880, 236.880, 525.840, 626.00, 282.00, 1, 344.00, NULL);
INSERT INTO `productos_sucursales` VALUES (191, 1, 191, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 253.680, 253.680, 653.520, 778.00, 302.00, 1, 476.00, NULL);
INSERT INTO `productos_sucursales` VALUES (192, 1, 192, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 125.160, 125.160, 293.160, 349.00, 149.00, 1, 200.00, NULL);
INSERT INTO `productos_sucursales` VALUES (193, 1, 193, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 87.360, 87.360, 202.440, 241.00, 104.00, 1, 137.00, NULL);
INSERT INTO `productos_sucursales` VALUES (194, 1, 194, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 87.360, 87.360, 202.440, 241.00, 104.00, 1, 137.00, NULL);
INSERT INTO `productos_sucursales` VALUES (195, 1, 195, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 114.240, 114.240, 255.360, 304.00, 136.00, 1, 168.00, NULL);
INSERT INTO `productos_sucursales` VALUES (196, 1, 196, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 393.120, 393.120, 1021.440, 1216.00, 468.00, 1, 748.00, NULL);
INSERT INTO `productos_sucursales` VALUES (197, 1, 197, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 16.800, 16.800, 47.040, 56.00, 20.00, 1, 36.00, NULL);
INSERT INTO `productos_sucursales` VALUES (198, 1, 198, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 57.120, 57.120, 126.000, 150.00, 68.00, 1, 82.00, NULL);
INSERT INTO `productos_sucursales` VALUES (199, 1, 199, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 147.000, 147.000, 325.920, 388.00, 175.00, 1, 213.00, NULL);
INSERT INTO `productos_sucursales` VALUES (200, 1, 200, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 14.280, 14.280, 31.920, 38.00, 17.00, 1, 21.00, NULL);
INSERT INTO `productos_sucursales` VALUES (201, 1, 201, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 33.600, 40.00, 18.00, 1, 22.00, NULL);
INSERT INTO `productos_sucursales` VALUES (202, 1, 202, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 25.200, 25.200, 48.720, 58.00, 30.00, 1, 28.00, NULL);
INSERT INTO `productos_sucursales` VALUES (203, 1, 203, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 65.520, 65.520, 124.320, 148.00, 78.00, 1, 70.00, NULL);
INSERT INTO `productos_sucursales` VALUES (204, 1, 204, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 29.400, 29.400, 55.440, 66.00, 35.00, 1, 31.00, NULL);
INSERT INTO `productos_sucursales` VALUES (205, 1, 205, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 44.520, 44.520, 84.000, 100.00, 53.00, 1, 47.00, NULL);
INSERT INTO `productos_sucursales` VALUES (206, 1, 206, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 27.720, 27.720, 58.800, 70.00, 33.00, 1, 37.00, NULL);
INSERT INTO `productos_sucursales` VALUES (207, 1, 207, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 55.440, 55.440, 123.480, 147.00, 66.00, 1, 81.00, NULL);
INSERT INTO `productos_sucursales` VALUES (208, 1, 208, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 58.800, 58.800, 131.040, 156.00, 70.00, 1, 86.00, NULL);
INSERT INTO `productos_sucursales` VALUES (209, 1, 209, 12.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 94.080, 94.080, 208.320, 248.00, 112.00, 1, 136.00, NULL);
INSERT INTO `productos_sucursales` VALUES (210, 1, 210, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 51.240, 51.240, 115.920, 138.00, 61.00, 1, 77.00, NULL);
INSERT INTO `productos_sucursales` VALUES (211, 1, 211, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 83.160, 83.160, 210.840, 251.00, 99.00, 1, 152.00, NULL);
INSERT INTO `productos_sucursales` VALUES (212, 1, 212, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 136.920, 136.920, 327.600, 390.00, 163.00, 1, 227.00, NULL);
INSERT INTO `productos_sucursales` VALUES (213, 1, 213, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 94.920, 94.920, 210.840, 251.00, 113.00, 1, 138.00, NULL);
INSERT INTO `productos_sucursales` VALUES (214, 1, 214, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 53.760, 53.760, 131.040, 156.00, 64.00, 1, 92.00, NULL);
INSERT INTO `productos_sucursales` VALUES (215, 1, 215, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 52.920, 52.920, 130.200, 155.00, 63.00, 1, 92.00, NULL);
INSERT INTO `productos_sucursales` VALUES (216, 1, 216, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 99.960, 99.960, 222.600, 265.00, 119.00, 1, 146.00, NULL);
INSERT INTO `productos_sucursales` VALUES (217, 1, 217, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 92.400, 92.400, 205.800, 245.00, 110.00, 1, 135.00, NULL);
INSERT INTO `productos_sucursales` VALUES (218, 1, 218, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 55.440, 55.440, 124.320, 148.00, 66.00, 1, 82.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (220, 1, 220, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 79.800, 79.800, 177.240, 211.00, 95.00, 1, 116.00, NULL);
INSERT INTO `productos_sucursales` VALUES (221, 1, 221, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 80.640, 80.640, 212.520, 253.00, 96.00, 1, 157.00, NULL);
INSERT INTO `productos_sucursales` VALUES (222, 1, 222, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 52.080, 52.080, 115.080, 137.00, 62.00, 1, 75.00, NULL);
INSERT INTO `productos_sucursales` VALUES (223, 1, 223, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 75.600, 75.600, 184.800, 220.00, 90.00, 1, 130.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (225, 1, 225, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 85.680, 85.680, 190.680, 227.00, 102.00, 1, 125.00, NULL);
INSERT INTO `productos_sucursales` VALUES (226, 1, 226, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 110.880, 110.880, 246.960, 294.00, 132.00, 1, 162.00, NULL);
INSERT INTO `productos_sucursales` VALUES (227, 1, 227, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 56.280, 56.280, 113.400, 135.00, 67.00, 1, 68.00, NULL);
INSERT INTO `productos_sucursales` VALUES (228, 1, 228, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 182.280, 182.280, 475.440, 566.00, 217.00, 1, 349.00, NULL);
INSERT INTO `productos_sucursales` VALUES (229, 1, 229, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 210.840, 210.840, 467.880, 557.00, 251.00, 1, 306.00, NULL);
INSERT INTO `productos_sucursales` VALUES (230, 1, 230, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 248.640, 248.640, 613.200, 730.00, 296.00, 1, 434.00, NULL);
INSERT INTO `productos_sucursales` VALUES (231, 1, 231, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 105.840, 105.840, 223.440, 266.00, 126.00, 1, 140.00, NULL);
INSERT INTO `productos_sucursales` VALUES (232, 1, 232, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 386.400, 386.400, 855.120, 1018.00, 460.00, 1, 558.00, NULL);
INSERT INTO `productos_sucursales` VALUES (233, 1, 233, 12.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 24.360, 24.360, 53.760, 64.00, 29.00, 1, 35.00, NULL);
INSERT INTO `productos_sucursales` VALUES (234, 1, 234, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 94.920, 94.920, 179.760, 214.00, 113.00, 1, 101.00, NULL);
INSERT INTO `productos_sucursales` VALUES (235, 1, 235, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 87.360, 87.360, 165.480, 197.00, 104.00, 1, 93.00, NULL);
INSERT INTO `productos_sucursales` VALUES (236, 1, 236, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 147.840, 147.840, 278.880, 332.00, 176.00, 1, 156.00, NULL);
INSERT INTO `productos_sucursales` VALUES (237, 1, 237, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 54.600, 54.600, 119.280, 142.00, 65.00, 1, 77.00, NULL);
INSERT INTO `productos_sucursales` VALUES (238, 1, 238, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 54.600, 54.600, 119.280, 142.00, 65.00, 1, 77.00, NULL);
INSERT INTO `productos_sucursales` VALUES (239, 1, 239, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 168.000, 168.000, 373.800, 445.00, 200.00, 1, 245.00, NULL);
INSERT INTO `productos_sucursales` VALUES (240, 1, 240, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 120.960, 120.960, 268.800, 320.00, 144.00, 1, 176.00, NULL);
INSERT INTO `productos_sucursales` VALUES (241, 1, 241, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 9.240, 9.240, 21.000, 25.00, 11.00, 1, 14.00, NULL);
INSERT INTO `productos_sucursales` VALUES (242, 1, 242, 11.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 8.400, 8.400, 14.280, 17.00, 10.00, 1, 7.00, NULL);
INSERT INTO `productos_sucursales` VALUES (243, 1, 243, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 56.280, 56.280, 124.320, 148.00, 67.00, 1, 81.00, NULL);
INSERT INTO `productos_sucursales` VALUES (244, 1, 244, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 6.720, 6.720, 12.600, 15.00, 8.00, 1, 7.00, NULL);
INSERT INTO `productos_sucursales` VALUES (245, 1, 245, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 101.640, 101.640, 247.800, 295.00, 121.00, 1, 174.00, NULL);
INSERT INTO `productos_sucursales` VALUES (246, 1, 246, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 12.600, 12.600, 26.880, 32.00, 15.00, 1, 17.00, NULL);
INSERT INTO `productos_sucursales` VALUES (247, 1, 247, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 22.680, 22.680, 42.840, 51.00, 27.00, 1, 24.00, NULL);
INSERT INTO `productos_sucursales` VALUES (248, 1, 248, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 54.600, 54.600, 133.560, 159.00, 65.00, 1, 94.00, NULL);
INSERT INTO `productos_sucursales` VALUES (249, 1, 249, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 104.160, 104.160, 262.920, 313.00, 124.00, 1, 189.00, NULL);
INSERT INTO `productos_sucursales` VALUES (250, 1, 250, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 88.200, 88.200, 189.840, 226.00, 105.00, 1, 121.00, NULL);
INSERT INTO `productos_sucursales` VALUES (251, 1, 251, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 73.080, 73.080, 122.640, 146.00, 87.00, 1, 59.00, NULL);
INSERT INTO `productos_sucursales` VALUES (252, 1, 252, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.920, 31.920, 56.280, 67.00, 38.00, 1, 29.00, NULL);
INSERT INTO `productos_sucursales` VALUES (253, 1, 253, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.920, 31.920, 59.640, 71.00, 38.00, 1, 33.00, NULL);
INSERT INTO `productos_sucursales` VALUES (254, 1, 254, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 144.480, 144.480, 321.720, 383.00, 172.00, 1, 211.00, NULL);
INSERT INTO `productos_sucursales` VALUES (255, 1, 255, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 249.480, 249.480, 358.680, 427.00, 297.00, 1, 130.00, NULL);
INSERT INTO `productos_sucursales` VALUES (256, 1, 256, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 16.800, 16.800, 36.960, 44.00, 20.00, 1, 24.00, NULL);
INSERT INTO `productos_sucursales` VALUES (257, 1, 257, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 16.800, 16.800, 36.960, 44.00, 20.00, 1, 24.00, NULL);
INSERT INTO `productos_sucursales` VALUES (258, 1, 258, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.920, 31.920, 71.400, 85.00, 38.00, 1, 47.00, NULL);
INSERT INTO `productos_sucursales` VALUES (259, 1, 259, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 31.920, 31.920, 71.400, 85.00, 38.00, 1, 47.00, NULL);
INSERT INTO `productos_sucursales` VALUES (260, 1, 260, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 283.920, 283.920, 558.600, 665.00, 338.00, 1, 327.00, NULL);
INSERT INTO `productos_sucursales` VALUES (261, 1, 261, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 111.720, 111.720, 225.120, 268.00, 133.00, 1, 135.00, NULL);
INSERT INTO `productos_sucursales` VALUES (262, 1, 262, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 94.920, 94.920, 210.840, 251.00, 113.00, 1, 138.00, NULL);
INSERT INTO `productos_sucursales` VALUES (263, 1, 263, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 144.480, 144.480, 367.080, 437.00, 172.00, 1, 265.00, NULL);
INSERT INTO `productos_sucursales` VALUES (264, 1, 264, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 99.960, 99.960, 221.760, 264.00, 119.00, 1, 145.00, NULL);
INSERT INTO `productos_sucursales` VALUES (265, 1, 265, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.840, 63.840, 141.120, 168.00, 76.00, 1, 92.00, NULL);
INSERT INTO `productos_sucursales` VALUES (266, 1, 266, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 247.800, 247.800, 550.200, 655.00, 295.00, 1, 360.00, NULL);
INSERT INTO `productos_sucursales` VALUES (267, 1, 267, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 66.360, 66.360, 147.000, 175.00, 79.00, 1, 96.00, NULL);
INSERT INTO `productos_sucursales` VALUES (268, 1, 268, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 82.320, 82.320, 182.280, 217.00, 98.00, 1, 119.00, NULL);
INSERT INTO `productos_sucursales` VALUES (269, 1, 269, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 37.800, 37.800, 83.160, 99.00, 45.00, 1, 54.00, NULL);
INSERT INTO `productos_sucursales` VALUES (270, 1, 270, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 37.800, 37.800, 84.000, 100.00, 45.00, 1, 55.00, NULL);
INSERT INTO `productos_sucursales` VALUES (271, 1, 271, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 38.640, 46.00, 18.00, 1, 28.00, NULL);
INSERT INTO `productos_sucursales` VALUES (272, 1, 272, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 37.800, 45.00, 18.00, 1, 27.00, NULL);
INSERT INTO `productos_sucursales` VALUES (273, 1, 273, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 185.640, 185.640, 411.600, 490.00, 221.00, 1, 269.00, NULL);
INSERT INTO `productos_sucursales` VALUES (274, 1, 274, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 222.600, 222.600, 492.240, 586.00, 265.00, 1, 321.00, NULL);
INSERT INTO `productos_sucursales` VALUES (275, 1, 275, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 38.640, 38.640, 86.520, 103.00, 46.00, 1, 57.00, NULL);
INSERT INTO `productos_sucursales` VALUES (276, 1, 276, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 38.640, 38.640, 86.520, 103.00, 46.00, 1, 57.00, NULL);
INSERT INTO `productos_sucursales` VALUES (277, 1, 277, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 24.360, 24.360, 53.760, 64.00, 29.00, 1, 35.00, NULL);
INSERT INTO `productos_sucursales` VALUES (278, 1, 278, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 90.720, 90.720, 231.840, 276.00, 108.00, 1, 168.00, NULL);
INSERT INTO `productos_sucursales` VALUES (279, 1, 279, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 126.000, 126.000, 279.720, 333.00, 150.00, 1, 183.00, NULL);
INSERT INTO `productos_sucursales` VALUES (280, 1, 280, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 126.000, 126.000, 279.720, 333.00, 150.00, 1, 183.00, NULL);
INSERT INTO `productos_sucursales` VALUES (281, 1, 281, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 362.040, 362.040, 821.520, 978.00, 431.00, 1, 547.00, NULL);
INSERT INTO `productos_sucursales` VALUES (282, 1, 282, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 217.560, 217.560, 535.920, 638.00, 259.00, 1, 379.00, NULL);
INSERT INTO `productos_sucursales` VALUES (283, 1, 283, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1258.320, 1258.320, 2796.360, 3329.00, 1498.00, 1, 1831.00, NULL);
INSERT INTO `productos_sucursales` VALUES (284, 1, 284, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1047.480, 1047.480, 2326.800, 2770.00, 1247.00, 1, 1523.00, NULL);
INSERT INTO `productos_sucursales` VALUES (285, 1, 285, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 203.280, 203.280, 467.880, 557.00, 242.00, 1, 315.00, NULL);
INSERT INTO `productos_sucursales` VALUES (286, 1, 286, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 203.280, 203.280, 467.880, 557.00, 242.00, 1, 315.00, NULL);
INSERT INTO `productos_sucursales` VALUES (287, 1, 287, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 267.960, 267.960, 690.480, 822.00, 319.00, 1, 503.00, NULL);
INSERT INTO `productos_sucursales` VALUES (288, 1, 288, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 315.840, 315.840, 801.360, 954.00, 376.00, 1, 578.00, NULL);
INSERT INTO `productos_sucursales` VALUES (289, 1, 289, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 110.880, 110.880, 246.960, 294.00, 132.00, 1, 162.00, NULL);
INSERT INTO `productos_sucursales` VALUES (290, 1, 290, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 267.120, 267.120, 687.120, 818.00, 318.00, 1, 500.00, NULL);
INSERT INTO `productos_sucursales` VALUES (291, 1, 291, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 165.480, 165.480, 418.320, 498.00, 197.00, 1, 301.00, NULL);
INSERT INTO `productos_sucursales` VALUES (292, 1, 292, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 244.440, 244.440, 616.560, 734.00, 291.00, 1, 443.00, NULL);
INSERT INTO `productos_sucursales` VALUES (293, 1, 293, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 244.440, 244.440, 616.560, 734.00, 291.00, 1, 443.00, NULL);
INSERT INTO `productos_sucursales` VALUES (294, 1, 294, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 107.520, 107.520, 272.160, 324.00, 128.00, 1, 196.00, NULL);
INSERT INTO `productos_sucursales` VALUES (295, 1, 295, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 107.520, 107.520, 272.160, 324.00, 128.00, 1, 196.00, NULL);
INSERT INTO `productos_sucursales` VALUES (296, 1, 296, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 191.520, 191.520, 481.320, 573.00, 228.00, 1, 345.00, NULL);
INSERT INTO `productos_sucursales` VALUES (297, 1, 297, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 48.720, 48.720, 91.560, 109.00, 58.00, 1, 51.00, NULL);
INSERT INTO `productos_sucursales` VALUES (298, 1, 298, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 270.480, 270.480, 527.520, 628.00, 322.00, 1, 306.00, NULL);
INSERT INTO `productos_sucursales` VALUES (299, 1, 299, 14.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 839.160, 839.160, 932.400, 1110.00, 999.00, 1, 111.00, NULL);
INSERT INTO `productos_sucursales` VALUES (300, 1, 300, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 199.920, 199.920, 443.520, 528.00, 238.00, 1, 290.00, NULL);
INSERT INTO `productos_sucursales` VALUES (301, 1, 301, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 290.640, 290.640, 645.120, 768.00, 346.00, 1, 422.00, NULL);
INSERT INTO `productos_sucursales` VALUES (302, 1, 302, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 112.560, 112.560, 214.200, 255.00, 134.00, 1, 121.00, NULL);
INSERT INTO `productos_sucursales` VALUES (303, 1, 303, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 519.120, 519.120, 1153.320, 1373.00, 618.00, 1, 755.00, NULL);
INSERT INTO `productos_sucursales` VALUES (304, 1, 304, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 519.120, 519.120, 1153.320, 1373.00, 618.00, 1, 755.00, NULL);
INSERT INTO `productos_sucursales` VALUES (305, 1, 305, 12.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.880, 26.880, 60.480, 72.00, 32.00, 1, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (306, 1, 306, 8.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 38.640, 38.640, 76.440, 91.00, 46.00, 1, 45.00, NULL);
INSERT INTO `productos_sucursales` VALUES (307, 1, 307, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 32.760, 32.760, 65.520, 78.00, 39.00, 1, 39.00, NULL);
INSERT INTO `productos_sucursales` VALUES (308, 1, 308, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 49.560, 49.560, 58.800, 70.00, 59.00, 1, 11.00, NULL);
INSERT INTO `productos_sucursales` VALUES (309, 1, 309, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 249.480, 249.480, 628.320, 748.00, 297.00, 1, 451.00, NULL);
INSERT INTO `productos_sucursales` VALUES (310, 1, 310, 21.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 42.840, 42.840, 95.760, 114.00, 51.00, 1, 63.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (312, 1, 312, 65.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 2.520, 2.520, 7.560, 9.00, 3.00, 1, 6.00, NULL);
INSERT INTO `productos_sucursales` VALUES (313, 1, 313, 54.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 3.360, 3.360, 6.720, 8.00, 4.00, 1, 4.00, NULL);
INSERT INTO `productos_sucursales` VALUES (314, 1, 314, 72.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 3.360, 3.360, 6.720, 8.00, 4.00, 1, 4.00, NULL);
INSERT INTO `productos_sucursales` VALUES (315, 1, 315, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 357.840, 357.840, 795.480, 947.00, 426.00, 1, 521.00, NULL);
INSERT INTO `productos_sucursales` VALUES (316, 1, 316, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1202.040, 1202.040, 2672.040, 3181.00, 1431.00, 1, 1750.00, NULL);
INSERT INTO `productos_sucursales` VALUES (317, 1, 317, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 295.680, 295.680, 717.360, 854.00, 352.00, 1, 502.00, NULL);
INSERT INTO `productos_sucursales` VALUES (318, 1, 318, 19.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 13.440, 13.440, 28.560, 34.00, 16.00, 1, 18.00, NULL);
INSERT INTO `productos_sucursales` VALUES (319, 1, 319, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 26.880, 26.880, 51.240, 61.00, 32.00, 1, 29.00, NULL);
INSERT INTO `productos_sucursales` VALUES (320, 1, 320, 30.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 29.400, 29.400, 64.680, 77.00, 35.00, 1, 42.00, NULL);
INSERT INTO `productos_sucursales` VALUES (321, 1, 321, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 36.120, 36.120, 80.640, 96.00, 43.00, 1, 53.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (323, 1, 323, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 466.200, 466.200, 512.400, 610.00, 555.00, 1, 55.00, NULL);
INSERT INTO `productos_sucursales` VALUES (324, 1, 324, 15.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 64.680, 64.680, 121.800, 145.00, 77.00, 1, 68.00, NULL);
INSERT INTO `productos_sucursales` VALUES (325, 1, 325, 50.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 36.120, 36.120, 74.760, 89.00, 43.00, 1, 46.00, NULL);
INSERT INTO `productos_sucursales` VALUES (326, 1, 326, 12.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 52.920, 52.920, 109.200, 130.00, 63.00, 1, 67.00, NULL);
INSERT INTO `productos_sucursales` VALUES (327, 1, 327, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 342.720, 342.720, 376.320, 448.00, 408.00, 1, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (328, 1, 328, 14.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1013.880, 1013.880, 1126.440, 1341.00, 1207.00, 1, 134.00, NULL);
INSERT INTO `productos_sucursales` VALUES (329, 1, 329, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 469.560, 469.560, 531.720, 633.00, 559.00, 1, 74.00, NULL);
INSERT INTO `productos_sucursales` VALUES (330, 1, 330, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 489.720, 489.720, 955.080, 1137.00, 583.00, 1, 554.00, NULL);
INSERT INTO `productos_sucursales` VALUES (331, 1, 331, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 470.400, 470.400, 811.440, 966.00, 560.00, 1, 406.00, NULL);
INSERT INTO `productos_sucursales` VALUES (332, 1, 332, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 293.160, 293.160, 651.840, 776.00, 349.00, 1, 427.00, NULL);
INSERT INTO `productos_sucursales` VALUES (333, 1, 333, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 34.440, 34.440, 79.800, 95.00, 41.00, 1, 54.00, NULL);
INSERT INTO `productos_sucursales` VALUES (334, 1, 334, 60.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 35.280, 35.280, 81.480, 97.00, 42.00, 1, 55.00, NULL);
INSERT INTO `productos_sucursales` VALUES (335, 1, 335, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 246.960, 246.960, 630.000, 750.00, 294.00, 1, 456.00, NULL);
INSERT INTO `productos_sucursales` VALUES (336, 1, 336, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 372.960, 372.960, 673.680, 802.00, 444.00, 1, 358.00, NULL);
INSERT INTO `productos_sucursales` VALUES (337, 1, 337, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 146.160, 146.160, 166.320, 198.00, 174.00, 1, 24.00, NULL);
INSERT INTO `productos_sucursales` VALUES (338, 1, 338, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 30.240, 30.240, 59.640, 71.00, 36.00, 1, 35.00, NULL);
INSERT INTO `productos_sucursales` VALUES (339, 1, 339, 10.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 42.840, 42.840, 99.120, 118.00, 51.00, 1, 67.00, NULL);
INSERT INTO `productos_sucursales` VALUES (340, 1, 340, 25.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 40.320, 40.320, 79.800, 95.00, 48.00, 1, 47.00, NULL);
INSERT INTO `productos_sucursales` VALUES (341, 1, 341, 30.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 55.440, 55.440, 110.880, 132.00, 66.00, 1, 66.00, NULL);
INSERT INTO `productos_sucursales` VALUES (342, 1, 342, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 77.280, 77.280, 88.200, 105.00, 92.00, 1, 13.00, NULL);
...
INSERT INTO `productos_sucursales` VALUES (344, 1, 344, 9.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 110.040, 110.040, 110.040, 131.00, 131.00, 1, 0.00, NULL);
INSERT INTO `productos_sucursales` VALUES (345, 1, 345, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 438.480, 438.480, 1106.280, 1317.00, 522.00, 1, 795.00, NULL);
INSERT INTO `productos_sucursales` VALUES (346, 1, 346, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 77.280, 77.280, 172.200, 205.00, 92.00, 1, 113.00, NULL);
INSERT INTO `productos_sucursales` VALUES (347, 1, 347, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 952.560, 952.560, 2116.800, 2520.00, 1134.00, 1, 1386.00, NULL);
INSERT INTO `productos_sucursales` VALUES (348, 1, 348, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 317.520, 317.520, 744.240, 886.00, 378.00, 1, 508.00, NULL);
INSERT INTO `productos_sucursales` VALUES (349, 1, 349, 108.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 2.520, 2.520, 6.720, 8.00, 3.00, 1, 5.00, NULL);
INSERT INTO `productos_sucursales` VALUES (350, 1, 350, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1381.800, 1381.800, 3070.200, 3655.00, 1645.00, 1, 2010.00, NULL);
INSERT INTO `productos_sucursales` VALUES (351, 1, 351, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 28.560, 28.560, 54.600, 65.00, 34.00, 1, 31.00, NULL);
INSERT INTO `productos_sucursales` VALUES (352, 1, 352, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 47.880, 47.880, 89.880, 107.00, 57.00, 1, 50.00, NULL);
INSERT INTO `productos_sucursales` VALUES (353, 1, 353, 20.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 17.640, 17.640, 33.600, 40.00, 21.00, 1, 19.00, NULL);
INSERT INTO `productos_sucursales` VALUES (354, 1, 354, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 84.840, 84.840, 188.160, 224.00, 101.00, 1, 123.00, NULL);
INSERT INTO `productos_sucursales` VALUES (355, 1, 355, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 918.960, 918.960, 1734.600, 2065.00, 1094.00, 1, 971.00, NULL);
INSERT INTO `productos_sucursales` VALUES (356, 1, 356, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1338.960, 1338.960, 2526.720, 3008.00, 1594.00, 1, 1414.00, NULL);
INSERT INTO `productos_sucursales` VALUES (357, 1, 357, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 55.440, 55.440, 105.000, 125.00, 66.00, 1, 59.00, NULL);
INSERT INTO `productos_sucursales` VALUES (358, 1, 358, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 136.080, 136.080, 256.200, 305.00, 162.00, 1, 143.00, NULL);
INSERT INTO `productos_sucursales` VALUES (359, 1, 359, 100.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 36.120, 43.00, 18.00, 1, 25.00, NULL);
INSERT INTO `productos_sucursales` VALUES (360, 1, 360, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 27.720, 27.720, 52.920, 63.00, 33.00, 1, 30.00, NULL);
INSERT INTO `productos_sucursales` VALUES (361, 1, 361, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 4.200, 4.200, 10.080, 12.00, 5.00, 1, 7.00, NULL);
INSERT INTO `productos_sucursales` VALUES (362, 1, 362, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 15.120, 15.120, 38.640, 46.00, 18.00, 1, 28.00, NULL);
INSERT INTO `productos_sucursales` VALUES (363, 1, 363, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 201.600, 201.600, 447.720, 533.00, 240.00, 1, 293.00, NULL);
INSERT INTO `productos_sucursales` VALUES (364, 1, 364, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 253.680, 253.680, 564.480, 672.00, 302.00, 1, 370.00, NULL);
INSERT INTO `productos_sucursales` VALUES (365, 1, 365, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 337.680, 337.680, 517.440, 616.00, 402.00, 1, 214.00, NULL);
INSERT INTO `productos_sucursales` VALUES (366, 1, 366, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 219.240, 219.240, 546.000, 650.00, 261.00, 1, 389.00, NULL);
INSERT INTO `productos_sucursales` VALUES (367, 1, 367, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 278.040, 278.040, 618.240, 736.00, 331.00, 1, 405.00, NULL);
INSERT INTO `productos_sucursales` VALUES (368, 1, 368, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 277.200, 277.200, 638.400, 760.00, 330.00, 1, 430.00, NULL);
INSERT INTO `productos_sucursales` VALUES (369, 1, 369, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 98.280, 98.280, 236.880, 282.00, 117.00, 1, 165.00, NULL);
INSERT INTO `productos_sucursales` VALUES (370, 1, 370, 2.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 163.800, 163.800, 354.480, 422.00, 195.00, 1, 227.00, NULL);
INSERT INTO `productos_sucursales` VALUES (371, 1, 371, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 105.000, 105.000, 256.200, 305.00, 125.00, 1, 180.00, NULL);
INSERT INTO `productos_sucursales` VALUES (372, 1, 372, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 42.000, 42.000, 107.520, 128.00, 50.00, 1, 78.00, NULL);
INSERT INTO `productos_sucursales` VALUES (373, 1, 373, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1452.360, 1452.360, 3227.280, 3842.00, 1729.00, 1, 2113.00, NULL);
INSERT INTO `productos_sucursales` VALUES (374, 1, 374, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1824.480, 1824.480, 4054.680, 4827.00, 2172.00, 1, 2655.00, NULL);
INSERT INTO `productos_sucursales` VALUES (375, 1, 375, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 80.640, 80.640, 179.760, 214.00, 96.00, 1, 118.00, NULL);
INSERT INTO `productos_sucursales` VALUES (376, 1, 376, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 61.320, 61.320, 131.040, 156.00, 73.00, 1, 83.00, NULL);
INSERT INTO `productos_sucursales` VALUES (377, 1, 377, 6.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.840, 63.840, 137.760, 164.00, 76.00, 1, 88.00, NULL);
INSERT INTO `productos_sucursales` VALUES (378, 1, 378, 7.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 45.360, 45.360, 99.960, 119.00, 54.00, 1, 65.00, NULL);
INSERT INTO `productos_sucursales` VALUES (379, 1, 379, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 61.320, 61.320, 115.080, 137.00, 73.00, 1, 64.00, NULL);
INSERT INTO `productos_sucursales` VALUES (380, 1, 380, 4.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 63.840, 63.840, 120.960, 144.00, 76.00, 1, 68.00, NULL);
INSERT INTO `productos_sucursales` VALUES (381, 1, 381, 5.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 54.600, 54.600, 131.880, 157.00, 65.00, 1, 92.00, NULL);
INSERT INTO `productos_sucursales` VALUES (382, 1, 382, 3.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 73.920, 73.920, 164.640, 196.00, 88.00, 1, 108.00, NULL);
INSERT INTO `productos_sucursales` VALUES (383, 1, 383, 1.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 125.160, 125.160, 278.040, 331.00, 149.00, 1, 182.00, NULL);
INSERT INTO `productos_sucursales` VALUES (384, 1, 384, 12.00, 1.00, NULL, '2022-06-01 18:21:25', 'VIG', 1478.400, 1478.400, 1596.000, 1596.00, 1760.00, 1, 140.00, NULL);
INSERT INTO `productos_sucursales` VALUES (385, 1, 385, 10000.00, 1.00, NULL, '2022-06-01 20:34:36', 'VIG', 42.000, 42.000, 42.000, 50.00, 50.00, 0, 25.00, NULL);
INSERT INTO `productos_sucursales` VALUES (386, 1, 386, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 42.000, 42.000, 42.000, 50.00, 50.00, 0, 25.00, NULL);
INSERT INTO `productos_sucursales` VALUES (387, 1, 387, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (388, 1, 388, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 100.800, 100.800, 100.800, 120.00, 120.00, 0, 60.00, NULL);
INSERT INTO `productos_sucursales` VALUES (389, 1, 389, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 210.000, 210.000, 210.000, 250.00, 250.00, 0, 125.00, NULL);
INSERT INTO `productos_sucursales` VALUES (390, 1, 390, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (391, 1, 391, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (392, 1, 392, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 100.800, 100.800, 100.800, 120.00, 120.00, 0, 60.00, NULL);
INSERT INTO `productos_sucursales` VALUES (393, 1, 393, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (394, 1, 394, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 117.600, 117.600, 117.600, 140.00, 140.00, 0, 70.00, NULL);
INSERT INTO `productos_sucursales` VALUES (395, 1, 395, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 33.600, 33.600, 33.600, 40.00, 40.00, 0, 20.00, NULL);
INSERT INTO `productos_sucursales` VALUES (396, 1, 396, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (397, 1, 397, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 100.800, 100.800, 100.800, 120.00, 120.00, 0, 60.00, NULL);
INSERT INTO `productos_sucursales` VALUES (398, 1, 398, 10000.00, 1.00, NULL, '2022-06-01 20:34:47', 'VIG', 100.800, 100.800, 100.800, 120.00, 120.00, 0, 60.00, NULL);
INSERT INTO `productos_sucursales` VALUES (399, 1, 399, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 50.400, 50.400, 50.400, 60.00, 60.00, 0, 30.00, NULL);
INSERT INTO `productos_sucursales` VALUES (400, 1, 400, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 201.600, 201.600, 201.600, 240.00, 240.00, 0, 120.00, NULL);
INSERT INTO `productos_sucursales` VALUES (401, 1, 401, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 126.000, 126.000, 126.000, 150.00, 150.00, 0, 75.00, NULL);
INSERT INTO `productos_sucursales` VALUES (402, 1, 402, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 42.000, 42.000, 42.000, 50.00, 50.00, 0, 25.00, NULL);
INSERT INTO `productos_sucursales` VALUES (403, 1, 403, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 33.600, 33.600, 33.600, 40.00, 40.00, 0, 20.00, NULL);
INSERT INTO `productos_sucursales` VALUES (404, 1, 404, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 33.600, 33.600, 33.600, 40.00, 40.00, 0, 20.00, NULL);
INSERT INTO `productos_sucursales` VALUES (405, 1, 405, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (406, 1, 406, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 252.000, 252.000, 252.000, 300.00, 300.00, 0, 150.00, NULL);
INSERT INTO `productos_sucursales` VALUES (407, 1, 407, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 319.200, 319.200, 319.200, 380.00, 380.00, 0, 190.00, NULL);
INSERT INTO `productos_sucursales` VALUES (408, 1, 408, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 319.200, 319.200, 319.200, 380.00, 380.00, 0, 190.00, NULL);
INSERT INTO `productos_sucursales` VALUES (409, 1, 409, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 117.600, 117.600, 117.600, 140.00, 140.00, 0, 70.00, NULL);
INSERT INTO `productos_sucursales` VALUES (410, 1, 410, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 336.000, 336.000, 336.000, 400.00, 400.00, 0, 200.00, NULL);
INSERT INTO `productos_sucursales` VALUES (411, 1, 411, 10000.00, 1.00, NULL, '2022-06-01 20:34:48', 'VIG', 630.000, 630.000, 630.000, 750.00, 750.00, 0, 375.00, NULL);
INSERT INTO `productos_sucursales` VALUES (412, 1, 412, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 100.800, 100.800, 100.800, 120.00, 120.00, 0, 60.00, NULL);
INSERT INTO `productos_sucursales` VALUES (413, 1, 413, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 117.600, 117.600, 117.600, 140.00, 140.00, 0, 70.00, NULL);
INSERT INTO `productos_sucursales` VALUES (414, 1, 414, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 67.200, 67.200, 67.200, 80.00, 80.00, 0, 40.00, NULL);
INSERT INTO `productos_sucursales` VALUES (415, 1, 415, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 126.000, 126.000, 126.000, 150.00, 150.00, 0, 75.00, NULL);
INSERT INTO `productos_sucursales` VALUES (416, 1, 416, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 75.600, 75.600, 75.600, 90.00, 90.00, 0, 45.00, NULL);
INSERT INTO `productos_sucursales` VALUES (417, 1, 417, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 336.000, 336.000, 336.000, 400.00, 400.00, 0, 200.00, NULL);
INSERT INTO `productos_sucursales` VALUES (418, 1, 418, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 336.000, 336.000, 336.000, 400.00, 400.00, 0, 200.00, NULL);
INSERT INTO `productos_sucursales` VALUES (419, 1, 419, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 151.200, 151.200, 151.200, 180.00, 180.00, 0, 90.00, NULL);
INSERT INTO `productos_sucursales` VALUES (420, 1, 420, 10000.00, 1.00, NULL, '2022-06-01 20:34:49', 'VIG', 100.800, 100.800, 100.800, 120.00, 120.00, 0, 60.00, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Catálogo de proveedores' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `sucursales` VALUES (1, 1, 'MATRIZ', 'AV. RAMÓN MEDOZA # 103, FRENTE A PLAZA LAS AMÉRICAS, COL.  JOSÉ MARÍA PINO SUÁREZ, VILLAHERMOSA, TABASCO. CP. 86020.', 'refaccionesitalika@gmail.com', '555555555555', '7777777777', '2022-03-08 14:47:46', 'VIG');
...
INSERT INTO `sucursales` VALUES (26, 1, 'MATRIZ', 'AV. RAMÓN MEDOZA # 103, COL. JOSÉ MARÍA PINO SUÁREZ, VILLAHERMOSA, TAB. CP. 86020.', 'refaccionesitalika@gmail.com', '9999999999', '6666666666', '2022-06-01 17:45:24', 'VIG');
INSERT INTO `sucursales` VALUES (27, 1, 'MATRIZ', 'AV. RAMÓN MEDOZA # 103, COL. JOSÉ MARÍA PINO SUÁREZ, VILLAHERMOSA, TAB. CP. 86020.', 'refaccionesitalika@gmail.com', '9999999999', '6666666666', '2022-06-01 17:47:32', 'VIG');
INSERT INTO `sucursales` VALUES (28, 1, 'MATRIZ', 'AV. RAMÓN MEDOZA # 103, COL. JOSÉ MARÍA PINO SUÁREZ, VILLAHERMOSA, TAB. CP. 86020.', 'refaccionesitalika@gmail.com', '9999999999', '6666666666', '2022-06-01 18:17:26', 'VIG');
...
-- Records of unidades
-- ----------------------------
INSERT INTO `unidades` VALUES (1, 1, 'PZA', 'PIEZA', '', '2022-06-01 18:17:26');
INSERT INTO `unidades` VALUES (2, 1, 'CAJA', 'CAJA', '', '2022-06-01 18:17:26');
INSERT INTO `unidades` VALUES (3, 1, 'KG', 'KILOGRAMO', '', '2022-06-01 18:17:26');
INSERT INTO `unidades` VALUES (4, 1, 'LT', 'LITRO', '', '2022-06-01 18:17:26');
INSERT INTO `unidades` VALUES (5, 1, 'M', 'METRO', '', '2022-06-01 18:17:27');
INSERT INTO `unidades` VALUES (6, 1, 'SERV', 'SERVICIO', '', '2022-06-01 18:17:27');
...
) ENGINE = InnoDB AUTO_INCREMENT = 13 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra las asociaciones de los roles a los usuarios' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `ventas`  (
  ...
  `numero_transaccion` int(11) NULL DEFAULT NULL COMMENT 'Número de transacción asociado',
  `usuario_alta` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Clave de usuario que da de alta el registro',
  `fecha_alta` timestamp(0) NOT NULL DEFAULT current_timestamp(0) COMMENT 'Fecha de alta del registro',
  `estatus_registro` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'VIG' COMMENT 'Indica si el registro esta VIG O NVG',
...
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registro de las ventas' ROW_FORMAT = DYNAMIC;
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra los detalles de las ventas' ROW_FORMAT = DYNAMIC;
