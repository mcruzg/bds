...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Catálogo de categorías de productos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Catálogo de productos o materiales';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos` VALUES (1,1,12,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-03-21 04:51:58','VIG','1647882251783',0,2,1,12.00),(2,1,4,'BUJIA NGK DCPR8EIX (C/4) NGK','00046355123495','2022-03-21 05:24:55','NVI','1647882224193',0,1,1,1.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Registra las descripciones asociadas a los productos';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Contiene la existencia de productos en una sucursal';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `productos_sucursales_impuestos` (
  ...
  PRIMARY KEY (`cve_producto_sucursal_impuesto`),
  KEY `fk_cve_producuto_sucursal_tb_impuesto` (`cve_producto_sucursal`),
  KEY `fk_cve_impuesto_producto_sucursal` (`cve_impuesto`),
...
INSERT INTO `productos_sucursales_impuestos` VALUES (15,4,1,'2022-03-21 17:03:46','NVI'),(16,2,1,'2022-03-21 17:04:14','VIG');
...
-- Dump completed on 2022-03-23 23:04:29
