...
) ENGINE = InnoDB AUTO_INCREMENT = 25 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Almacena los menú del sistema' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `movimientos`  (
  ...
  `descripcion_movimiento` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Descripción u observación asociada al movimiento',
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra los movimientos de valores durante un corte de caja' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `movimientos` VALUES (3, NULL, 'ENTRADA', '2022-05-03 08:58:08', 500.00, 'FONDO DE CAJA', 'EF', '2022-05-03 08:58:08', 'VIG', 1, NULL, NULL);
...
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Contiene la existencia de productos en una sucursal' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `productos_sucursales` VALUES (2, 1, 1, 0.00, 0.00, NULL, '2022-03-20 22:54:25', 'NVI', 958.000, 825.862, 103.233, 119.75, 53.00, 1, 50.00, 479.000);
...
INSERT INTO `productos_sucursales` VALUES (9, 1, 1, 0.00, 0.00, NULL, '2022-04-21 08:52:17', 'VIG', 68.822, 825.862, 103.233, 119.75, 958.00, 1, 50.00, 479.000);
...
INSERT INTO `productos_sucursales_impuestos` VALUES (28, 9, 1, '2022-04-21 08:52:17', 'VIG');
...
INSERT INTO `roles_accion` VALUES (8, 2, 1, '2022-05-03 09:54:19', 'VIG');
INSERT INTO `roles_accion` VALUES (9, 2, 2, '2022-05-03 09:54:26', 'VIG');
INSERT INTO `roles_accion` VALUES (10, 2, 3, '2022-05-03 09:54:33', 'VIG');
INSERT INTO `roles_accion` VALUES (11, 2, 4, '2022-05-03 09:54:38', 'VIG');
INSERT INTO `roles_accion` VALUES (12, 2, 5, '2022-05-03 09:54:47', 'VIG');
INSERT INTO `roles_accion` VALUES (13, 3, 1, '2022-05-03 09:55:04', 'VIG');
INSERT INTO `roles_accion` VALUES (14, 3, 2, '2022-05-03 09:55:08', 'VIG');
INSERT INTO `roles_accion` VALUES (15, 3, 3, '2022-05-03 09:55:13', 'VIG');
INSERT INTO `roles_accion` VALUES (16, 3, 4, '2022-05-03 09:55:17', 'VIG');
INSERT INTO `roles_accion` VALUES (17, 3, 5, '2022-05-03 09:55:20', 'VIG');
INSERT INTO `roles_accion` VALUES (18, 3, 6, '2022-05-03 09:55:27', 'VIG');
INSERT INTO `roles_accion` VALUES (19, 3, 7, '2022-05-03 09:55:36', 'VIG');
...
) ENGINE = InnoDB AUTO_INCREMENT = 34 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Asociaciones de menús a roles' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `roles_menu` VALUES (25, 2, 1, '2022-05-03 10:01:21', 'VIG');
INSERT INTO `roles_menu` VALUES (26, 2, 7, '2022-05-03 10:01:28', 'VIG');
INSERT INTO `roles_menu` VALUES (27, 2, 11, '2022-05-03 10:01:33', 'VIG');
INSERT INTO `roles_menu` VALUES (28, 2, 10, '2022-05-03 10:01:40', 'VIG');
INSERT INTO `roles_menu` VALUES (29, 3, 1, '2022-05-03 10:01:48', 'VIG');
INSERT INTO `roles_menu` VALUES (30, 3, 7, '2022-05-03 10:01:56', 'VIG');
INSERT INTO `roles_menu` VALUES (31, 3, 9, '2022-05-03 10:02:02', 'VIG');
INSERT INTO `roles_menu` VALUES (32, 3, 10, '2022-05-03 10:02:09', 'VIG');
INSERT INTO `roles_menu` VALUES (33, 3, 11, '2022-05-03 10:02:24', 'VIG');
...
INSERT INTO `users` VALUES (11, 'USUARIO DE VENTAS EN MOSTRADOR', 'ventas@gmail.com', NULL, '$2y$10$lxyOPrBblyP4eApsDoRnG.72qB1C0rXOu.lRoMr6iSim0owzxSIk.', NULL, NULL, NULL, NULL, 'VIG', 1, 'ventas', 1);
INSERT INTO `users` VALUES (12, 'USUARIO DE CAJAS', 'cajas@gmail.com', NULL, '$2y$10$lxyOPrBblyP4eApsDoRnG.72qB1C0rXOu.lRoMr6iSim0owzxSIk.', NULL, NULL, NULL, NULL, 'VIG', 1, 'cajas', 1);
INSERT INTO `users` VALUES (13, 'USUARIO ADMINISTRADOR DEL SISTEMA', 'administrador@gmail.com', NULL, '$2y$10$lxyOPrBblyP4eApsDoRnG.72qB1C0rXOu.lRoMr6iSim0owzxSIk.', NULL, NULL, NULL, NULL, 'VIG', 1, 'admin', 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra las asociaciones de los roles a los usuarios' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `users_roles` VALUES (4, 2, 11, '2022-05-03 10:04:25', 'VIG');
...
) ENGINE = InnoDB AUTO_INCREMENT = 46 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registro de las ventas' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ventas` VALUES (45, 1, 1, NULL, NULL, 'JOSE MENDEZ', 'NORMAL', '2022-05-03 09:35:43', 'TICKET', 'PORPAGAR', '62713D22E90DB', NULL, NULL, '2022-05-03 09:33:06', 'VIG', 2714.55, 0.00, 3148.90, 0.00, 'TRES MIL CIENTO CUARENTA Y OCHO PESOS 90/100 MNX', '', 2255.50, 893.40, 1944.39, 770.16, 1);
...
) ENGINE = InnoDB AUTO_INCREMENT = 85 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra los detalles de las ventas' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `ventas_detalles` VALUES (82, 45, 8, 3.00, 'PZA', 'CAPTURADO', '2022-05-03 09:33:06', 'VIG', '3', 'ESTE ES OTRO PRODUCTO DE PRUEBA', 155.172, 180.00, 155.172, 180.00, 465.516, 540.00, 465.52, 540.00, 0.00, 0.00, 103.45, 360.00, 310.34, 0.160, 120.00, 1.00);
INSERT INTO `ventas_detalles` VALUES (83, 45, 5, 10.00, 'PZA', 'CAPTURADO', '2022-05-03 09:33:06', 'VIG', '651516565', 'PRODUCTO DE PRUEBA DE CAPTURA', 101.024, 117.19, 101.024, 117.19, 1010.240, 1171.90, 1010.24, 1171.90, 0.00, 0.00, 80.82, 937.50, 808.19, 0.160, 1500.00, 16.00);
INSERT INTO `ventas_detalles` VALUES (84, 45, 9, 12.00, 'PZA', 'CAPTURADO', '2022-05-03 09:33:06', 'VIG', '00750300927201', 'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.', 103.233, 119.75, 103.233, 119.75, 1238.796, 1437.00, 1238.80, 1437.00, 0.00, 0.00, 68.82, 958.00, 825.86, 0.160, 958.00, 12.00);
