...
CREATE TABLE `acciones` (
  ...
  `cve_menu` int(11) DEFAULT NULL,
  PRIMARY KEY (`cve_accion`) USING BTREE,
  KEY `acciones_FK` (`cve_menu`) USING BTREE,
  CONSTRAINT `acciones_FK` FOREIGN KEY (`cve_menu`) REFERENCES `menus` (`cve_menu`)
...
INSERT INTO `acciones` VALUES (1,'ope_editar_prod','Editar descripcion del producto en venta','2022-04-10 02:49:07','VIG',7),(2,'ope_cantidad_prod','Editar cantidad de producto en venta','2022-04-10 02:49:07','VIG',7),(3,'ope_borrar_prod','Borrar producto en venta','2022-04-10 02:49:07','VIG',7),(4,'ope_descuento_prod','Aplicar descuento producto venta','2022-04-10 02:49:07','VIG',7),(5,'ope_espera_venta','Poner en espera la venta','2022-04-10 02:49:07','VIG',7),(6,'ope_recupera_venta','Recuperar venta','2022-04-10 02:49:07','VIG',7),(7,'ope_paga_venta','Pagar venta','2022-04-10 02:49:07','VIG',7);
...
CREATE TABLE `devoluciones` (
  ...
  `descripcion` varchar(100) DEFAULT NULL,
  `cve_principal` int(11) DEFAULT NULL,
  `cve_detalle` int(11) DEFAULT NULL,
  `tipo_devolucion` varchar(100) DEFAULT NULL,
  `fecha_alta` timestamp NOT NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`cve_devolucion`)
...
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Almacena las entradas de material';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `entradas` VALUES (17,1,2,NULL,'2022-04-05 19:27:20','COMPRA','1','CAPTURA',NULL,'2022-04-05 19:27:20','VIG'),(18,1,1,NULL,'2022-04-05 20:04:58','COMPRA','aaaaaa','CAPTURA',NULL,'2022-04-05 20:04:58','VIG'),(19,1,2,NULL,'2022-04-05 20:19:16','COMPRA','222','CAPTURA',NULL,'2022-04-05 20:19:16','VIG'),(20,1,1,NULL,'2022-04-05 20:21:06','COMPRA','333','CAPTURA',NULL,'2022-04-05 20:21:06','VIG'),(21,1,2,NULL,'2022-04-05 20:22:11','COMPRA','444','CAPTURA',NULL,'2022-04-05 20:22:11','VIG'),(22,1,2,NULL,'2022-04-05 20:23:55','COMPRA','555','CAPTURA',NULL,'2022-04-05 20:23:55','VIG'),(23,1,1,NULL,'2022-04-05 20:26:43','COMPRA','6666','CAPTURA',NULL,'2022-04-05 20:26:43','VIG'),(24,1,1,NULL,'2022-05-02 03:09:32','COMPRA','','APLICADA',NULL,'2022-05-02 03:09:32','VIG'),(25,1,1,NULL,'2022-05-02 03:21:33','COMPRA','123','APLICADA',NULL,'2022-05-02 03:21:33','VIG'),(26,1,1,NULL,'2022-05-02 05:05:43','COMPRA','67','APLICADA',NULL,'2022-05-02 05:05:43','VIG'),(27,1,2,NULL,'2022-05-02 05:06:32','COMPRA','90','APLICADA',NULL,'2022-05-02 05:06:32','VIG'),(28,1,1,NULL,'2022-05-02 05:10:35','COMPRA','91','APLICADA',NULL,'2022-05-02 05:10:35','VIG'),(29,1,1,NULL,'2022-05-02 05:12:05','COMPRA','92','APLICADA',NULL,'2022-05-02 05:12:05','VIG'),(30,1,1,NULL,'2022-05-03 04:06:01','COMPRA','567','APLICADA',NULL,'2022-05-03 04:06:01','VIG'),(31,1,NULL,1,'2022-05-08 16:21:42','TRASPASO','','APLICADA',NULL,'2022-05-08 16:21:42','VIG');
...
CREATE TABLE `entradas_productos` (
  ...
  `unidad_medida_entrada` varchar(255) DEFAULT NULL,
  `fecha_alta` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de alta del registro',
  `estatus_registro` varchar(100) DEFAULT 'VIG' COMMENT 'Indica si el registro esta VIG O NVG',
  ...
  `precio_normal` decimal(11,2) DEFAULT NULL,
  `precio_normal_neto` decimal(11,2) DEFAULT NULL,
  `importe_normal` decimal(11,2) DEFAULT NULL,
  ...
  `importe_entrada_neto` decimal(11,2) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Almacena el detalle de las entradas de material';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `entradas_productos` VALUES (8,17,2,NULL,NULL,'2022-04-05 19:27:57',12,2,NULL,'2022-04-05 19:27:57','VIG',10.50,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(9,23,1,NULL,NULL,'2022-04-05 20:30:24',12,2,NULL,'2022-04-05 20:30:24','VIG',15.00,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,10.00),(10,24,1,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-05-02 03:09:32',1,2,'CAJA','2022-05-02 03:09:32','VIG',958.00,958.00,92.61,53.00,NULL,958.00,958.00,153.28,0.00,0.00,958.00,958.00,12.00),(11,25,1,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-05-02 03:21:33',1,2,'CAJA','2022-05-02 03:21:33','VIG',958.00,958.00,101.03,53.00,NULL,958.00,1111.28,153.28,0.00,0.00,958.00,958.00,12.00),(12,26,3,'PRODUCTO DE PRUEBA DE CAPTURA','651516565','2022-05-02 05:05:43',1,2,'CAJA','2022-05-02 05:05:43','VIG',80.82,80.82,5.05,1500.00,NULL,80.82,80.82,12.93,0.00,0.00,80.82,80.82,16.00),(13,27,3,'PRODUCTO DE PRUEBA DE CAPTURA','651516565','2022-05-02 05:06:32',1,2,'CAJA','2022-05-02 05:06:32','VIG',80.82,80.82,5.05,1500.00,NULL,80.82,80.82,12.93,0.00,0.00,80.82,80.82,16.00),(14,28,1,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-05-02 05:10:35',1,2,'CAJA','2022-05-02 05:10:35','VIG',958.00,958.00,79.83,53.00,NULL,958.00,958.00,153.28,0.00,0.00,958.00,958.00,12.00),(15,29,1,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-05-02 05:12:05',1,2,'CAJA','2022-05-02 05:12:05','VIG',958.00,958.00,79.83,53.00,NULL,958.00,958.00,153.28,0.00,0.00,958.00,958.00,12.00),(16,30,1,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-05-03 04:06:01',10,2,'CAJA','2022-05-03 04:06:01','VIG',958.00,8775.28,87.75,53.00,NULL,8775.28,9580.00,1532.80,10.00,8775.28,87752.80,9580.00,12.00),(17,31,1,'ACEITE SUPERTECH PACK DE 12 PIEZAS SAE40 DE 946 ML.','00750300927201','2022-05-08 16:21:42',1,2,'CAJA','2022-05-08 16:21:42','VIG',958.00,958.00,79.83,53.00,NULL,958.00,958.00,153.28,0.00,0.00,958.00,958.00,12.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Almacena los menú del sistema';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `productos_sucursales` VALUES (1,1,1,0.00,0.00,NULL,'2022-03-21 04:51:58','NVI',52.371,628.448,78.556,91.13,729.00,1,50.00,NULL),(2,1,1,180.00,0.00,NULL,'2022-03-21 04:54:25','VIG',958.000,825.862,79.830,103.23,958.00,1,50.00,958.000),(3,1,2,4.00,0.00,NULL,'2022-03-21 05:24:55','NVI',1018.103,1018.103,1537.336,1783.31,1181.00,1,50.00,NULL),(4,1,2,4.00,0.00,NULL,'2022-03-21 05:28:15','NVI',1681.422,1681.422,2101.778,2438.06,1950.45,1,25.00,975.225),(5,1,3,32.00,0.00,NULL,'2022-03-22 17:27:04','VIG',80.819,1293.103,101.024,117.19,1500.00,1,25.00,NULL),(6,1,2,4.00,0.00,NULL,'2022-03-22 17:27:43','VIG',1853.448,1853.448,2316.810,2687.50,2150.00,1,25.00,1075.000),(7,1,4,0.00,0.00,NULL,'2022-03-27 04:40:24','VIG',23.591,188.724,35.386,41.05,218.92,1,50.00,NULL),(8,1,5,0.00,0.00,NULL,'2022-03-31 16:08:33','VIG',103.448,103.448,155.172,180.00,120.00,1,50.00,NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Catálogo de roles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles` VALUES (1,1,'Administrador','2022-04-09 22:22:53','VIG'),(2,1,'Vendedor','2022-04-09 22:22:53','VIG'),(3,1,'Cajero','2022-04-09 22:22:53','VIG'),(4,1,'Consultor','2022-04-09 22:22:53','VIG');
...
INSERT INTO `roles_accion` VALUES (1,1,1,'2022-04-10 02:53:35','VIG'),(2,1,2,'2022-04-10 02:53:35','VIG'),(3,1,3,'2022-04-10 02:53:35','VIG'),(4,1,4,'2022-04-10 02:53:35','VIG'),(5,1,5,'2022-04-10 02:53:35','VIG'),(6,1,6,'2022-04-10 02:53:35','VIG'),(7,1,7,'2022-04-10 02:53:35','VIG');
...
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Asociaciones de menús a roles';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `roles_menu` VALUES (1,1,1,'2022-04-09 22:24:24','VIG'),(2,1,2,'2022-04-09 22:24:24','VIG'),(3,1,3,'2022-04-09 22:24:24','NVI'),(4,1,4,'2022-04-09 22:24:24','NVI'),(5,1,5,'2022-04-09 22:24:24','NVI'),(6,1,6,'2022-04-09 22:24:24','NVI'),(7,1,7,'2022-04-09 22:24:24','VIG'),(8,1,8,'2022-04-09 22:24:24','VIG'),(9,1,9,'2022-04-09 22:24:24','VIG'),(10,1,10,'2022-04-09 22:24:24','VIG'),(11,1,11,'2022-04-09 22:24:24','VIG'),(12,1,12,'2022-04-09 22:24:24','VIG'),(13,1,13,'2022-04-09 22:24:24','VIG'),(14,1,14,'2022-04-09 22:24:24','VIG'),(15,1,15,'2022-04-09 22:24:24','VIG'),(16,1,16,'2022-04-09 22:24:24','VIG'),(17,1,17,'2022-04-09 22:24:24','VIG'),(18,1,18,'2022-04-09 22:24:24','VIG'),(19,1,19,'2022-04-09 22:24:24','VIG'),(20,1,20,'2022-04-09 22:24:24','VIG'),(21,1,21,'2022-04-09 22:24:24','VIG'),(22,1,22,'2022-04-09 22:24:24','VIG'),(23,1,23,'2022-04-09 22:24:24','VIG'),(24,1,24,'2022-04-09 22:24:24','VIG'),(25,1,25,'2022-05-03 04:10:36','VIG');
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Registra las asociaciones de los roles a los usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users_roles` VALUES (1,1,1,'2022-04-09 22:33:15','VIG'),(2,1,5,'2022-04-10 23:17:12','VIG');
...
CREATE TABLE `ventas` (
  ...
  `numero_transaccion` int(11) DEFAULT NULL COMMENT 'Número de transacción asociado',
  `usuario_alta` varchar(50) DEFAULT NULL COMMENT 'Clave de usuario que da de alta el registro',
  `fecha_alta` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de alta del registro',
  `estatus_registro` varchar(100) DEFAULT 'VIG' COMMENT 'Indica si el registro esta VIG O NVG',
...
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Registro de las ventas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Registra los detalles de las ventas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-05-09  8:24:38
