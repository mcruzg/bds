...
CREATE TABLE `movimientos` (
  ...
  KEY `fk_movimiento_caja` (`cve_caja`),
  KEY `fk_movimiento_venta` (`cve_venta`),
...
CREATE TABLE `users` (
  ...
  KEY `fk_users_empresa` (`cve_empresa`),
...
INSERT INTO `users` VALUES (1,'Miguel Angel Cruz Garcia','miguelcruz',NULL,'$2y$10$Lf5rxaanF7QUf33D3YI9GOWFNzGVbNFJgoT.8yzRi5.ESaQ5n4fUa',NULL,'2022-04-03 21:32:37','2022-04-03 21:32:37','9933465024','VIG',1,'miguelcruz'),(4,'DANIEL VAZQUEZ PERALTA','danielvazquez@tabasco.gob.mx',NULL,'$2y$10$YpLiX/WWuTDY2ZdOFkIrMeIY5.o9T0WqFRa3mwQ2mmdixbfDSkAH6',NULL,'2022-04-05 06:48:51','2022-04-05 06:48:51',NULL,'VIG',1,'danielvazquez'),(5,'JOSE MENDEZ MONDRAGON','josecmendez@tabasco.gob.mx',NULL,'$2y$10$S3ISjmMRtfvwZ/YhNj6Bmuoby7Oz.OTIxWgM4dTuIsOeyn9AxOdPa',NULL,'2022-04-05 07:30:13','2022-04-05 07:30:13',NULL,'VIG',1,'josemendez'),(10,'SOFIA ALVAREZ MORENO','sofiaalvarez1890@gmail.com',NULL,'$2y$10$lxyOPrBblyP4eApsDoRnG.72qB1C0rXOu.lRoMr6iSim0owzxSIk.',NULL,'2022-04-05 08:00:31','2022-04-05 08:00:31',NULL,NULL,NULL,'sofiaalvarez');
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Registro de las ventas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=78 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='Registra los detalles de las ventas';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-04-04 23:01:48
