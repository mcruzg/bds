...
) ENGINE = InnoDB AUTO_INCREMENT = 17 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Catálogo de categorías de productos' ROW_FORMAT = Dynamic;
...
-- Records of clientes
-- ----------------------------
INSERT INTO `clientes` VALUES (1, 1, 'VENTAS EN MOSTRADOR', 'F', 'XXXX1212121XX', '', '', NULL, NULL, '2022-03-08 15:44:56', 'VIG', NULL, NULL);
...
INSERT INTO `clientes` VALUES (3, 1, 'SELENE DEL CARMEN LOPEZ OSORIO', 'F', 'LOOS050505LL3', 'AV. GARDENAS NUM. 23, COL. PORFIRIO DIAZ, CENTLA TABASCO. CP. 85210', 'SELENELO@HOTMAIL.COM', '9934125566', 0, '2022-03-08 16:05:10', 'VIG', NULL, NULL);
...
-- ----------------------------
INSERT INTO `listas_catalogos` VALUES (1, 1, 'tipo_cliente1', '{\"FÍSICA\":\"FÍSICA\",\"MORAL\":\"MORAL\"}', '2022-03-08 16:30:23', 'VIG');
...
INSERT INTO `listas_catalogos` VALUES (15, 1, 'tipo_venta', '[\"NORMAL\",\"SERVICIO\",\"GARANTÍA\"]', '2022-03-08 16:48:14', 'VIG');
INSERT INTO `listas_catalogos` VALUES (17, 1, 'tipo_comprobante', '{\"TICKET\":\"TICKET\",\"FACTURA\":\"FACTURA\"}', '2022-03-08 16:49:04', 'VIG');
...
INSERT INTO `listas_catalogos` VALUES (21, 1, 'ventas_config', '{\"documento\":\"TICKET\",\"imprimir\":1,\"cliente\":{\"cve_cliente\":1,\"cve_empresa\":1,\"cliente\":\"VENTAS EN MOSTRADOR\"}}', '2022-03-24 08:46:23', 'VIG');
INSERT INTO `listas_catalogos` VALUES (22, 1, 'tipo_cliente', '[{\"id\":\"F\",\"value\":\"FÍSICA\"},{\"id\":\"M\",\"value\":\"MORAL\"}]', '2022-03-24 08:51:57', 'VIG');
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Catálogo de productos o materiales' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 22 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra las descripciones asociadas a los productos' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 7 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Contiene la existencia de productos en una sucursal' ROW_FORMAT = Dynamic;
...
INSERT INTO `productos_sucursales` VALUES (5, 1, 3, 0.00, 0.00, NULL, '2022-03-22 11:27:04', 'VIG', 73.242, 1293.103, 91.553, 117.19, 1500.00, 1, 25.00, NULL);
...
INSERT INTO `productos_sucursales_impuestos` VALUES (22, 5, 1, '2022-03-22 11:30:09', 'VIG');
INSERT INTO `productos_sucursales_impuestos` VALUES (23, 5, 2, '2022-03-22 11:30:09', 'VIG');
INSERT INTO `productos_sucursales_impuestos` VALUES (24, 5, 3, '2022-03-22 11:30:09', 'VIG');
...
CREATE TABLE `ventas`  (
  ...
  `numero_transaccion` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Número de transacción asociado',
  `usuario_alta` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Clave de usuario que da de alta el registro',
  `fecha_alta` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de alta del registro',
  `estatus_registro` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'VIG' COMMENT 'Indica si el registro esta VIG O NVG',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registro de las ventas' ROW_FORMAT = Dynamic;
...
CREATE TABLE `ventas_detalles`  (
  ...
  `cve_mano_obra` int(11) NULL DEFAULT NULL COMMENT 'Identificador del catálogo de mano de obra',
  `cantidad` decimal(11, 2) NULL DEFAULT NULL COMMENT 'Cantidad de producto o material',
  `unidad_medida` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT 'Unidad de medida del producto o material: PIEZA, LITRO, METRO',
  `precio_producto` decimal(11, 2) NULL DEFAULT NULL COMMENT 'Precio del producto al momento de la venta',
  `descuento_aplicado` int(11) NULL DEFAULT NULL COMMENT 'Porcentaje de descuento aplicado al producto',
  ...
  `cve_nota_credito` int(11) NULL DEFAULT NULL COMMENT 'Identificador de la nota de crédito',
  `fecha_alta` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'Fecha de alta del registro',
  `estatus_registro` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'VIG' COMMENT 'Indica si el registro esta VIG O NVG',
  PRIMARY KEY (`cve_venta_detalle`) USING BTREE,
  INDEX `fk_mano_obra_venta_detalle`(`cve_mano_obra`) USING BTREE,
  INDEX `fk_nota_credito_venta_detalle`(`cve_nota_credito`) USING BTREE,
  ...
  CONSTRAINT `fk_mano_obra_venta_detalle` FOREIGN KEY (`cve_mano_obra`) REFERENCES `mano_obra` (`cve_mano_obra`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_nota_credito_venta_detalle` FOREIGN KEY (`cve_nota_credito`) REFERENCES `notas_credito` (`cve_nota_credito`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = 'Registra los detalles de las ventas' ROW_FORMAT = Dynamic;
